...
use commands::claude::{
    ...
    clear_checkpoint_manager, continue_agent_session, continue_claude_code, create_checkpoint,
    create_project, execute_agent_session, execute_claude_code, find_claude_md_files,
